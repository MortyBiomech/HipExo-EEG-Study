...
if ~exist('EEG_preprocessed_and_ICA','var')
    ...
    if ~exist('EEG_AMICA','var')
        ...
        %     [], ...
        %     [bemobil_config.filename_prefix num2str(subject) '_' bemobil_config.amica_filename_output], ...
        %     output_filepath, ...
        ...
        %     bemobil_config.AMICA_max_iter);
        % 
        % [ALLEEG EEG CURRENTSET] = bemobil_signal_decomposition(...
        %     ALLEEG, ...
        %     EEG, ...
        %     CURRENTSET,...
	    %     amica, ...
