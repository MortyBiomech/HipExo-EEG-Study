...
if ~exist('generalInfo', 'var')
    ...
    generalInfo.InstitutionName                         = 'Technical University of Darmstadt';
    generalInfo.InstitutionalDepartmentName             = 'Lauflabor Locomotion Lab';
    generalInfo.InstitutionAddress                      = 'Alexanderstr. 10, 64289, Darmstadt';
    generalInfo.TaskDescription                         = 'Tracking reference path with a custom built Knee Exoskeleton and conputer-interface';
